...
<table border="1"> 
	...
	%><tr>
	<td><%= data.getFileName() %></td><br>
	<td><%= data.getFileSize() %></td><br>
	<td><%= data.getFileUser() %></td><br>
	<td><%= data.getUploadTime() %></td><br>
	<td><form action="/fileDownload" method="post">
	<input type="hidden" name="filePath" value="<%=data.getFilePath()%>">
	<input type="hidden" name="fileUser" value="<%=data.getFileUser() %>">
	<input type="submit" value="다운로드"></td>
	<td>
