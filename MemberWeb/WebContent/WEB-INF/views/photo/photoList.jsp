...
<body>
	<h1>사진게시판</h1>
	<section>
		<div id="photo-wrapper" style="padding: 100x"></div>
		<div id="photo-btn-container" style="text-align: center;">
			<button id="more-btn" totalCount="${totalCount }" currentCount="0">더보기</button>
					...
					.ajax({
						...
						success : function(data) {
							...
							for (var i = 0; i < data.length; i++) {
								...
								html += "<img src='/upload/photo/"
										+ data[i].photoFilepath
										+ "' width='100%'>";
								html += "<p class='caption'>"
										+ data[i].photoContent + "</p></div>";
							}
